...
function earningMoneyInWeek(days) {
    let hours = 10;
    if (days == 1) {
        return `Monday:I will earning rest of the week :${(hours*4)+(hours*6)+(hours*8)+(hours*10)+(hours*2)}$`;
    } else if (days == 2) {
        return `Tuesday: I will earning rest of the week:${(hours*6)+(hours*8)+(hours*10)+(hours*2)}$`;
    } else if (days == 3) {
        return ` Wednesday:  I will earning rest of the week:${(hours*8)+(hours*10)+(hours*2)}$`;
    } else if (days == 4) {
        return ` Thursday: I will earning rest of the week:${(hours*10)+(hours*2)}$`;
    } else if (days == 5) {
        return ` Friday: I will earning rest of the week${hours*2}$`;
    } else if (days == 6) {
        return ` Saturday: I will earning rest of the week:${hours*2}$`;
    } else if (days == 7) {
        return ` Sunday:day Off!. I will not earning this week`;
    }
}
